...
const Projects = () => {
  return (
    <section id="projects" className="py-12 md:py-20 px-6 md:px-12 bg-gray-950 text-white">
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-4xl font-bold mb-8 text-indigo-400">Featured Projects</h2>
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2">
          {projects.map((project, i) => (
            ...
            >
              <div className="h-48 sm:h-56 md:h-56 overflow-hidden">
                <img
                  src={project.image}
                  alt={project.title}
              ...
              <div className="p-6 text-left">
                <h3 className="text-xl sm:text-2xl font-semibold text-indigo-300 mb-2">{project.title}</h3>
